...
namespace LinqLabs.作業
{
    public partial class Frm作業_3 : Form
    {
        ...
        private void 搜尋班級學生成績(object sender, EventArgs e)
        {
            #region 搜尋 班級學生成績
        ...
        private void 每個學生個人成績(object sender, EventArgs e)
        {
        ...
        private void 隨機統計100個學生分數(object sender, EventArgs e)
        {
        ...
        private void 分成三群(object sender, EventArgs e)
        {
        ...
        private void 依檔案大小分組檔案(object sender, EventArgs e)
        {
            dataGridView1.DataSource = null;
        ...
        private void 依年份大小分組檔案(object sender, EventArgs e)
        {
            dataGridView1.DataSource = null;
            System.IO.DirectoryInfo dir = new System.IO.DirectoryInfo(@"c:\windows");
        ...
        private void NWProducts低中高價產品(object sender, EventArgs e)
        {
            ...
            {
                item.CategoryName,
                PriceCategory = GetPriceCategory((decimal)item.AvgUnitPrice),
        ...
        private void Orders_Group_by年(object sender, EventArgs e)
        {
            dataGridView1.DataSource = null;
        ...
        private void Orders_Groupby_年_月(object sender, EventArgs e)
        {
            dataGridView1.DataSource = null;
        ...
        private void 總銷售金額(object sender, EventArgs e)
        {
            dataGridView1.DataSource = null;
        ...
        private void 銷售最好的top5業務員(object sender, EventArgs e)
        {
            dataGridView1.DataSource = null;
        ...
        private void NW產品最高單價前5筆_包括類別名稱(object sender, EventArgs e)
        {
            dataGridView1.DataSource = null;
        ...
        private void NW產品有任何一筆單價大於300(object sender, EventArgs e)
        {
            dataGridView1.DataSource = null;
            // 檢查是否有任何產品的單價大於 300

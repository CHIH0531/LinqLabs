...
namespace MyHomeWork
{
    public partial class Frm作業_2 : Form
    {
        ...
        private void All腳踏車(object sender, EventArgs e)
        {
        ...
        private void 區間腳踏車(object sender, EventArgs e)
        {
            dataGridView1.DataSource = null;
            var q = from o in this.adwDataSet1.ProductPhoto
        ...
        private void 某年腳踏車(object sender, EventArgs e)
        {
            dataGridView1.DataSource = null;
            int year;
        ...
        private void 某季腳踏車_有幾筆_(object sender, EventArgs e)
        {
            dataGridView1.DataSource = null;
            int selectedYear;
